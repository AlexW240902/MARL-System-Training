...
class Args:
    ...
    wandb_project_name: str = "VS_Train"
    ...
    for global_step in range(args.total_timesteps):
        ...
        if first_model == "dqn":
            ...
            if random.random() < epsilon:
                ...
                step_actions0 = np.array([envs.single_action_space.sample() for _ in range(envs.num_envs // 2)])
            else:
        ...
        if second_model == "dqn":
            ...
            if random.random() < epsilon:
                #print("RANDOM", epsilon)
                step_actions1 = np.array([envs.single_action_space.sample() for _ in range(envs.num_envs // 2)])
            else:
                #print("NORMAL", epsilon)
