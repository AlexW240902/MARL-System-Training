...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default="ppo_train",
    ...
    parser.add_argument("--total-timesteps", type=int, default=8000,  # CleanRL default: 2000000
        help="total timesteps of the experiments")
    parser.add_argument("--learning-rate", type=float, default=2.5e-4,
        help="the learning rate of the optimizer")
    parser.add_argument("--num-envs", type=int, default=8,                          #### NOMBRE D'AGENTS (PER TANT NOMBRE ENTORNS /= 2)
