...
def parse_args():
    ...
    parser.add_argument("--wandb-project-name", type=str, default="Entombed-Coop",
    ...
    parser.add_argument("--total-timesteps", type=int, default=200000,  # CleanRL default: 2000000
