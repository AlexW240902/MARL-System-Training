...
def parse_args():
    ...
    parser.add_argument("--track", type=lambda x: bool(strtobool(x)), default=True, nargs="?", const=True,    ###### CANVIAR AIXO SI VULL CREAR PROJECTE AL COMPTE DE WANDB
        help="if toggled, this experiment will be tracked with Weights and Biases")
    parser.add_argument("--wandb-project-name", type=str, default="Entombed-Comp",
    ...
    parser.add_argument("--env-id", type=str, default="entombed_competitive_v3",
        help="the id of the environment")
    parser.add_argument("--total-timesteps", type=int, default=32000,  # CleanRL default: 2000000
        ...
        for step in range(0, args.num_steps):   #num_steps = nombre de steps que fa cada entorn abans d'actualitzar política
            ...
            for idx, rew in enumerate(reward):
                ...
                if dones[game*2 + player_idx]:
                    ...
                    writer.add_scalar(
                        f"charts/episodic_return-game{game}-player{player_idx}",
                        episodic_returns[game][player_idx],
                        global_step,
                    )
                    writer.add_scalar(
                        f"charts/episodic_length-game{game}-player{player_idx}",
            ...
            #    player_idx = idx % 2
            #    if "episode" in item and "r" in item["episode"] and "l" in item["episode"]:
            #        print(
            ...
            #        )
            #    else:
            #        print(f"Step {global_step}, Info for Player {player_idx}: {item}")
