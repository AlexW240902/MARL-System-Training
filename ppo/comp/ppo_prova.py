...
class PPOAgent:
    ...
    def update(self, trajectory):
        ...
        states = torch.tensor(states_np, dtype=torch.float).to(device) / 255.0
        ...
        print(f"Policy Loss: {policy_loss}, Version: {policy_loss._version}")
...
while env.agents or ngames < maxgames:
    ...
    while env.agents:
        ...
        #if (done[agent] and terminations[agent]): print(agent, "terminated")
